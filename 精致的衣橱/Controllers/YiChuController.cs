...
namespace 精致的衣橱.Controllers
{
    ...
    public class YiChuController : Controller
    {
        ...
        public ActionResult TianqiClothes()
        {
            ...
            //}
            if (yichuview.shirtbytemp.FirstOrDefault() != null)
            {
                yichuview.dapeishangyi = yichuview.shirtbytemp.FirstOrDefault();
                var a = yichuview.shirtbytemp.FirstOrDefault();
                yichuview.daipeixiyi = nethers.NetherBaiDa(a.Season, a.Color).FirstOrDefault();
            }
