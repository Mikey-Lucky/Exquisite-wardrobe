...
namespace DALFactory
{
    public class DataAccess
    {
        ...
        public static INoteSelect CreateNoteSelect()
        {
            string className = AssemblyName + "." + db + "NoteSelect";
            return (INoteSelect)Assembly.Load(AssemblyName).CreateInstance(className);
        }
